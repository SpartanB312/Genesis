...
def clazz(access: Access, name: String, superName: String = "java/lang/Object", interfaces: List[String] = List(),
          signature: Nullable[String] = null, version: Int = Java7)(builder: ClassBuilder ?=> Unit): ClassNode =
    val classNode = ClassNode()
    classNode.access = access.toInt
    classNode.name = name
...
def CONSTRUCTOR(access: Access, description: String, signature: Nullable[String] = null, exception: Nullable[Array[String]] = null)(builder: MethodBuilder ?=> Unit)(using classBuilder: ClassBuilder): Unit =
