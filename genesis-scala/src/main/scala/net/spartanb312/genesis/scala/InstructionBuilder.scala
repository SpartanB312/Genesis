...
inline def TABLESWITCH(range: Range, default: LabelNode, labels: LabelNode*)(using InstructionBuilder): Unit =
    +TableSwitchInsnNode(range.start, range.end, default, labels*)

inline def LOOKUPSWITCH(default: LabelNode)(keys: Int*)(labels: LabelNode*)(using InstructionBuilder): Unit =
    +LookupSwitchInsnNode(default, keys.toArray, labels.toArray)
...
inline def GETSTATIC(owner: String, name: String, desc: String)(using InstructionBuilder): Unit =
    +FieldInsnNode(Opcodes.GETSTATIC, owner, name, desc)
inline def PUTSTATIC(owner: String, name: String, desc: String)(using InstructionBuilder): Unit =
    +FieldInsnNode(Opcodes.PUTSTATIC, owner, name, desc)
inline def GETFIELD(owner: String, name: String, desc: String)(using InstructionBuilder): Unit =
    +FieldInsnNode(Opcodes.GETFIELD, owner, name, desc)
inline def PUTFIELD(owner: String, name: String, desc: String)(using InstructionBuilder): Unit =
    +FieldInsnNode(Opcodes.PUTFIELD, owner, name, desc)

inline def INVOKEVIRTUAL(owner: String, name: String, desc: String)(using InstructionBuilder) =
    +MethodInsnNode(Opcodes.INVOKEVIRTUAL, owner, name, desc)
inline def INVOKESPECIAL(owner: String, name: String, desc: String)(using InstructionBuilder) =
    +MethodInsnNode(Opcodes.INVOKESPECIAL, owner, name, desc)
inline def INVOKESTATIC(owner: String, name: String, desc: String)(using InstructionBuilder) =
    +MethodInsnNode(Opcodes.INVOKESTATIC, owner, name, desc)
inline def INVOKEINTERFACE(owner: String, name: String, desc: String)(using InstructionBuilder) =
    +MethodInsnNode(Opcodes.INVOKEINTERFACE, owner, name, desc)

inline def INVOKEDYNAMIC(name: String, desc: String, bsm: Handle, bsmArgs: Any*)(using InstructionBuilder) =
...
given string2Label(using InstructionBuilder): Conversion[String, Label] with
    override def apply(x: String): Label = L(x)
